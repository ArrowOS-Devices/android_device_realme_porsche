...
BOARD_ONEPLUS_DYNAMIC_PARTITIONS_SIZE := 11186208768 # (BOARD_SUPER_PARTITION_SIZE - 4 MiB)
...
$(foreach p, $(call to-upper, $(BOARD_ONEPLUS_DYNAMIC_PARTITIONS_PARTITION_LIST)), \
    ...
    $(eval BOARD_$(p)IMAGE_PARTITION_RESERVED_SIZE := 500000000)) # Reserve 500MB for each dynamic partition
